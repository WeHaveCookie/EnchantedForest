...
function linkEnchantedForestLibs(EnchantedForestPath)

-- //////////// COOMMON SETTINGS ////////////

	filter { "platforms:Win32 or platforms:x64"}
		includedirs {
			EnchantedForestPath .. "../External/SFML-2.3.2/include",
		}
...
-- //////////// WIN32 SETTINGS ////////////
	...
	filter { "platforms:Win32"}
		...
		libdirs {
			EnchantedForestPath .. "../External/SFML-2.3.2/lib/x32",
		}
...
-- //////////// WIN64 SETTINGS ////////////
	filter { "platforms:x64"}
		...
		libdirs {
			EnchantedForestPath .. "../External/SFML-2.3.2/lib/x64",
		}
...
function includeEnchantedForest(EnchantedForestPath)
	
	-- Normalize Path
	if not string.endswith(EnchantedForestPath, "/") then
		EnchantedForestPath = EnchantedForestPath .. "/"
	end
	
-- //////////// COMMON SETTINGS ////////////
		kind "StaticLib"
		targetdir(EnchantedForestPath .. "Lib/%{cfg.platform}/%{cfg.buildcfg}/")
		removelinkoptions {
			"/LARGEADDRESSAWARE",
		}
		...
		removefiles {
			EnchantedForestPath .. "Project/VisualStudio2015/main.cpp"
		}

	
end

function EnchantedForestProject(name, EnchantedForestPath)
		
		EnchantedForestPath = EnchantedForestPath or "./"
		...
		project(name)
			...
			editandcontinue "On"
			pchheader "stdafx.h"
			pchsource(EnchantedForestPath .. "Project/VisualStudio/stdafx.cpp")
			files {
				EnchantedForestPath .. "Classes/**.c",
				EnchantedForestPath .. "Classes/**.cpp",
				EnchantedForestPath .. "Classes/**.h",
				EnchantedForestPath .. "Classes/**.inl",
				EnchantedForestPath .. "Project/VisualStudio2015/*.c",
				EnchantedForestPath .. "Project/VisualStudio2015/*.cpp",
				EnchantedForestPath .. "Project/VisualStudio2015/*.h",
			}
			vpaths {
				["*"] = { "." },
			}
			includedirs {
				EnchantedForestPath .. "Project/VisualStudio2015",
				EnchantedForestPath .. "Classes",
				EnchantedForestPath .. "../External/ImGui",
				EnchantedForestPath .. "../External/rapidjson",
				EnchantedForestPath .. "../External/moodycamel",
...
-- //////////// WIN64 SETTINGS ////////////
			...
			filter "configurations:Debug"
				defines { "EnchantedForest_DEBUG", "_DEBUG" }
				runtime "Debug"
			...
			filter "configurations:Final"
				defines { "EnchantedForest_FINAL", "NDEBUG" }
				runtime "Release"
				optimize "Full"
		...
		linkEnchantedForestLibs(EnchantedForestPath)
